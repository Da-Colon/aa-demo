export const appConfig = {
  ...
  smartAccountFactoryAddress: '0xD4CA64EE6671a1c68092D459793137CB3776b03b' as `0x${string}`,
  ...
  demoSubscriptionPaymasterAddress: "0xA6BC8557f57F802b0fA3D25184D42C20aE26d061" as `0x${string}`,
}
