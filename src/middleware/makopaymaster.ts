...
export const makoPaymasterAndDataMiddleware: Parameters<AccountSigner["withPaymasterMiddleware"]>["0"] = {
  dummyPaymasterDataMiddleware: async (struct: any) => {
    ...
    const paymasterAndData = appConfig.demoTokenPaymasterAddress;
