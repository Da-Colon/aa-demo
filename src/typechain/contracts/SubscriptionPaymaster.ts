...
export interface SubscriptionPaymasterInterface extends utils.Interface {
  functions: {
    ...
    "tokenChargePerHour()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "tokenChargePerHour",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ServicePaid(address,uint256)": EventFragment;
  };
...
export interface ServicePaidEventObject {
  user: string;
  amount: BigNumber;
}
export type ServicePaidEvent = TypedEvent<
  [string, BigNumber],
  ServicePaidEventObject
>;

export type ServicePaidEventFilter = TypedEventFilter<ServicePaidEvent>;

export interface SubscriptionPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SubscriptionPaymasterInterface;
  ...
  functions: {
    ...
    tokenChargePerHour(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "ServicePaid(address,uint256)"(
      user?: PromiseOrValue<string> | null,
      amount?: null
    ): ServicePaidEventFilter;
    ServicePaid(
      user?: PromiseOrValue<string> | null,
      amount?: null
    ): ServicePaidEventFilter;
