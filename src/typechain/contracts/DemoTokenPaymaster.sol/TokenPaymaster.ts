...
export interface TokenPaymaster extends BaseContract {
  ...
  functions: {
    ...
    serviceCost(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    serviceCost(overrides?: CallOverrides): Promise<PopulatedTransaction>;
